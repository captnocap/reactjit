...
export const dexSpatialExplorerSection = defineGallerySection({
  ...
  composedOf: [
    ...
    "cart/app/gallery/components/dex-canvas-node/DexCanvasNode.tsx",
    "cart/app/gallery/components/dex-canvas-ring/DexCanvasRing.tsx",
    "cart/app/gallery/components/dex-canvas-edge/DexCanvasEdge.tsx",
  ],
  stories: [
    defineGalleryStory({
      id: "dex-spatial-explorer/default",
      title: "Dex Spatial Explorer",
      source: "cart/app/gallery/components/dex-spatial-explorer/DexSpatialExplorer.tsx",
      status: 'ready',

...
import { transcribe, type TranscribeResult } from '@reactjit/runtime/hooks/whisper';
...
export default function WhisperBench() {
  ...
  // mode 1 + -40dB floor (more permissive than voice_lab's -30dB to let
  // quieter trailing syllables through — soft "of", "and", etc.).

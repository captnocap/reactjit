// Probe cart for the Codex backend through the unified worker contract.
//
// Spawns codex_sdk.Codex via __worker_start("codex_app_server", ...),
// streams normalized WorkerEvent rows back. No Settings rows, no
// Connection rows — straight bind, like cart/local-chat.
      ...
      <Box style={{ flexDirection: 'column', gap: 4 }}>
        ...
        <Box style={{ paddingTop: 4 }}>
          <span style={{ color: '#888', fontFamily: 'monospace', fontSize: 11 }}>
            worker: {assistant.workerId ?? '(none)'} · backend: codex_app_server
          </span>
        </Box>
        {assistant.error ? (
          <Box style={{ paddingTop: 4 }}>

(() => {
  ...
  // cart/testing_carts/spinner.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  init_primitives();
  var import_react = __toESM(require_react());
  var COLORS2 = ["red", "blue", "green", "yellow", "cyan", "magenta"];
  function SpinnerTest() {
    const [spinIdx, setSpinIdx] = (0, import_react.useState)(0);
    (0, import_react.useEffect)(() => {
      const id = setInterval(() => {
        setSpinIdx((i) => (i + 1) % COLORS2.length);
      }, 100);
      return () => clearInterval(id);
    }, []);
    return /* @__PURE__ */ __jsx(Box, { style: { width: "100%", height: "100%", backgroundColor: "black", padding: 20, flexDirection: "row", gap: 20, justifyContent: "center", alignItems: "center" } }, /* @__PURE__ */ __jsx(Box, { style: { flexDirection: "row", gap: 16 } }, COLORS2.map((color, i) => /* @__PURE__ */ __jsx(
      Box,
      {
        key: i,
        style: {
  ...
  reconciler.updateContainer(React4.createElement(SpinnerTest, {}), container, null, null);
})();
/**
 * @license React

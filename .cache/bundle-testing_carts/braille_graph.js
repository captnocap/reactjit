(() => {
  ...
  // vendor/react/cjs/react.development.js
  var require_react_development = __commonJS({
    "vendor/react/cjs/react.development.js"(exports, module) {
      "use strict";
      init_jsx_shim();
      init_ambient();
  ...
  var require_react = __commonJS({
    "vendor/react/index.js"(exports, module) {
      "use strict";
      init_jsx_shim();
      init_ambient();
      init_ambient_primitives();
  ...
  var init_theme_presets = __esm({
    "runtime/theme_presets.ts"() {
      ...
      init_ambient();
      init_ambient_primitives();
      rgb = (r2, g, b) => "#" + [r2, g, b].map((n) => n.toString(16).padStart(2, "0")).join("");
      rounded_airy = {
        radiusSm: 4,
        radiusMd: 8,
        radiusLg: 16,
  ...
  var React2, AUDIO_MODULE_TYPE, AUDIO_PARAM_INDEX, host, hostAdd, hostRemove, hostConnect, hostDisconnect, hostSetParam, hostNoteOn, hostNoteOff, hostMasterGain, AudioContext, AudioBase, Audio;
  var init_audio = __esm({
    "runtime/audio.tsx"() {
      ...
      hostNoteOn = (id, midi) => host().__audioNoteOn?.(id, midi);
      hostNoteOff = (id) => host().__audioNoteOff?.(id);
  ...
  var init_primitives = __esm({
    "runtime/primitives.tsx"() {
      ...
      Cartridge = ({ src, cartridgeSrc, ...rest }) => h("View", { ...rest, cartridgeSrc: cartridgeSrc ?? src }, rest.children);
      ...
      Scene3DBase.Mesh = ({ geometry, material, color, position, rotation, scale, radius, tubeRadius, sizeX, sizeY, sizeZ, ...rest }) => {
        ...
        const [r2, g, b] = _hexToRgb(matColor, [0.8, 0.8, 0.8]);
      ...
      Scene3DBase.AmbientLight = ({ color, intensity, ...rest }) => {
        const [r2, g, b] = _hexToRgb(color, [1, 1, 1]);
        return h("View", {
          ...rest,
          scene3dLight: true,
  ...
  function hostForward(hotKey) {
    host2().__routerForward?.();
    persistCurrentPath(hotKey);
    notifyRouterListeners();
  }
  function hostCurrentPath() {
    return host2().__routerCurrentPath?.() ?? "/";
  }
  ...
  function writeHotPath(hotKey, path) {
    if (!hotKey) return;
    try {
      host2().__hot_set?.(hotKey, JSON.stringify(normalizePath(path)));
    } catch {
    }
  }
  ...
  var React3, host2, DEFAULT_ROUTER_HOT_KEY, routerListeners, NO_MATCH, RouterContext;
  ...
  function emit2(channel, payload) {
    dispatchListeners(channel, payload);
  }
  var host3, _listeners;
  var init_ffi = __esm({
    "runtime/ffi.ts"() {
      init_jsx_shim();
      init_ambient();
      ...
      host3.__ffiEmit = (channel, payload) => {
  ...
  var import_react2, host4, listeners2, drainTimer;
  ...
  function dispatchClaudeEvent(input) {
    ...
    emit2("system:claude", entry);
    if (tool) emit2(`system:claude:${tool}`, entry);
    if (phase) emit2(`system:claude:${phase}`, entry);
  }
  ...
  function useIFTTT(trigger, action) {
    const [, forceTick] = (0, import_react3.useState)(0);
    const counterRef = (0, import_react3.useRef)(0);
    const lastRef = (0, import_react3.useRef)(void 0);
    const lastAtRef = (0, import_react3.useRef)(0);
    const actionRef = (0, import_react3.useRef)(action);
    ...
    const prevCondRef = (0, import_react3.useRef)(false);
  ...
  var import_react3, state, stateWatchers, SDL_KMOD_SHIFT, SDL_KMOD_CTRL, SDL_KMOD_ALT, SDL_KMOD_GUI, SDL_KEY_NAMES, G;
  var init_useIFTTT = __esm({
    "runtime/hooks/useIFTTT.ts"() {
      ...
      if (!G.__ifttt_handlers_installed) {
        ...
        G.__ifttt_onKeyDown = (packed) => emit2("__keydown", decodeKey(packed));
        G.__ifttt_onKeyUp = (packed) => emit2("__keyup", decodeKey(packed));
        G.__ifttt_onClipboardChange = () => {
          ...
          emit2("system:clipboard", text);
        };
        G.__ifttt_onSystemFocus = (gained) => {
          emit2(gained ? "system:focus" : "system:blur", { at: Date.now() });
        };
        G.__ifttt_onSystemDrop = () => {
          ...
          emit2("system:fileDropped", path);
        };
        G.__ifttt_onSystemCursor = (x, y, dx, dy) => {
          emit2("system:cursor:move", { x, y, dx, dy });
        };
        G.__ifttt_onSystemSlowFrame = (ms) => emit2("system:slowFrame", { ms });
        G.__ifttt_onSystemHang = (count) => emit2("system:hang", { count });
        G.__ifttt_onSystemRam = (used, total) => {
          const percent = total > 0 ? used / total * 100 : 0;
          emit2("system:ram", { used, total, percent });
        };
        G.__ifttt_onSystemVram = (used, total) => {
          const percent = total > 0 ? used / total * 100 : 0;
          emit2("system:vram", { used, total, percent });
        };
        G.__ifttt_onSystemResize = (w, h2) => {
          emit2("system:resize", { w, h: h2 });
        };
      }
  ...
  // vendor/scheduler/cjs/scheduler.development.js
  var require_scheduler_development = __commonJS({
    "vendor/scheduler/cjs/scheduler.development.js"(exports) {
      "use strict";
      init_jsx_shim();
      init_ambient();
      init_ambient_primitives();
  ...
  // vendor/scheduler/index.js
  var require_scheduler = __commonJS({
    "vendor/scheduler/index.js"(exports, module) {
      "use strict";
      init_jsx_shim();
      init_ambient();
      init_ambient_primitives();
  ...
  // vendor/react-reconciler/cjs/react-reconciler.development.js
  var require_react_reconciler_development = __commonJS({
    "vendor/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
      "use strict";
      init_jsx_shim();
      init_ambient();
      init_ambient_primitives();
  ...
  // vendor/react-reconciler/index.js
  var require_react_reconciler = __commonJS({
    "vendor/react-reconciler/index.js"(exports, module) {
      "use strict";
      init_jsx_shim();
      init_ambient();
      init_ambient_primitives();
  ...
  function parseClass(cls, grad, trans) {
    ...
    if (token.startsWith("border-")) {
      ...
      if (rest.startsWith("dash-w-")) {
        ...
        return !isNaN(n) ? { borderDashWidth: n } : void 0;
      }
      if (rest.startsWith("dash-")) {
        ...
        if (dash >= 0) {
          ...
          if (!isNaN(on) && !isNaN(off)) return { borderDashOn: on, borderDashOff: off };
        } else {
          const n = parseFloat(body);
          if (!isNaN(n)) return { borderDashOn: n, borderDashOff: n };
        }
        return void 0;
      }
      if (rest.startsWith("flow-")) {
        const n = parseFloat(rest.slice(5));
        return !isNaN(n) ? { borderFlowSpeed: neg(n) } : void 0;
      }
    ...
    if (token.startsWith("shadow-")) {
      const rest = token.slice(7);
      if (rest === "method-rect") return { shadowMethod: "rect" };
      if (rest === "method-sdf") return { shadowMethod: "sdf" };
  ...
  var HTML_STRIP_PROPS = /* @__PURE__ */ new Set([
    "alt",
    "htmlFor",
    "href",
    "target",
  ...
  var pendingCommands = [];
  var rootInstances = [];
  var WINDOW_HOST_TYPES = /* @__PURE__ */ new Set(["Window", "Notification"]);
  ...
  function assignHostWindow(node, windowId) {
    if (!isInstance(node)) return;
    node.hostWindowId = WINDOW_HOST_TYPES.has(node.type) ? node.id : windowId;
    for (const child of node.children) {
      assignHostWindow(child, node.hostWindowId ?? null);
    }
  }
  function markParent(parent, child) {
  ...
  function buildWindowOwnerMap() {
    const ownerById = /* @__PURE__ */ new Map();
    const windowRoots = /* @__PURE__ */ new Set();
    const walk = (node, inherited) => {
      ...
      for (const child of node.children) walk(child, ownWindow);
    };
    for (const root of rootInstances) walk(root, null);
    return { ownerById, windowRoots };
  }
  function annotateWindowCommands(commands) {
    const { ownerById, windowRoots } = buildWindowOwnerMap();
    const traceWindows = !!globalThis.__TRACE_WINDOWS;
    for (const cmd of commands) {
      if (cmd.window_id != null) continue;
      const id = typeof cmd.id === "number" ? cmd.id : void 0;
      const childId = typeof cmd.childId === "number" ? cmd.childId : void 0;
      const parentId = typeof cmd.parentId === "number" ? cmd.parentId : void 0;
      const owner = (id != null ? ownerById.get(id) : void 0) ?? (childId != null ? ownerById.get(childId) : void 0) ?? (parentId != null ? ownerById.get(parentId) : void 0) ?? (parentId != null && windowRoots.has(parentId) ? parentId : void 0);
      if (owner != null) {
        cmd.window_id = owner;
        cmd.windowId = owner;
        if (traceWindows && (cmd.op === "CREATE" || cmd.op === "APPEND" || cmd.op === "APPEND_TO_ROOT" || cmd.op === "REMOVE")) {
          try {
            globalThis.__hostLog?.(0, `[window-route/js] op=${cmd.op} id=${cmd.id ?? ""} parent=${cmd.parentId ?? ""} child=${cmd.childId ?? ""} window=${owner}`);
          } catch {
          }
        }
      }
  ...
  function commandWithWindow(cmd, windowId) {
  ...
  var microtask = typeof globalThis.queueMicrotask === "function" ? globalThis.queueMicrotask.bind(globalThis) : (fn) => {
  ...
  var hostConfig = {
    ...
    appendChildToContainer(container2, child) {
      hostLog(`[hostConfig] appendChildToContainer container=${container2.id} child=${child.id}`);
    ...
    removeChild(parent, child) {
      ...
      const windowId = isInstance(child) ? child.hostWindowId : WINDOW_HOST_TYPES.has(parent.type) ? parent.id : parent.hostWindowId;
      markParent(null, child);
    ...
    commitUpdate(instance, updatePayload, _type, _oldProps, newProps) {
      ...
      if (updatePayload && !updatePayload.__handlersOnly && !updatePayload.__closuresOnly) {
        const handlerNames = Object.keys(handlers);
        const hasHandlers = handlerNames.length > 0;
  ...
  // cart/testing_carts/braille_graph.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  ...
  var FUNCTIONS = {
    ...
    noise: (x, t) => {
      const v = Math.sin(x * 8 + t) * 0.5 + Math.sin(x * 17 + t * 1.4) * 0.25 + Math.sin(x * 31 - t * 0.6) * 0.12;
      return v * 0.9;
    },
    lissajous: (x, t) => {
      const a = 3;
  ...
  function generatePlot(cols, rows, mode, t, zoom) {
    const charW = 2;
    const charH = 4;
  ...
  function BrailleGraphCart() {
    const [mode, setMode] = (0, import_react.useState)("sine");
    const [animate, setAnimate] = (0, import_react.useState)(true);
    const [t, setT] = (0, import_react.useState)(0);
    const [zoom, setZoom] = (0, import_react.useState)(10);
    (0, import_react.useEffect)(() => {
      if (!animate) return;
      const host5 = globalThis;
      const raf = typeof host5.requestAnimationFrame === "function" ? host5.requestAnimationFrame.bind(host5) : null;
      let id = 0;
      ...
      id = raf ? raf(loop) : setTimeout(() => loop(performance.now()), 16);
      return () => {
        if (raf) host5.cancelAnimationFrame(id);
        else clearTimeout(id);
      };
    }, [animate]);
    const gridCols = 48;
    const gridRows = 22;
    const { lines, maxVal, minVal } = (0, import_react.useMemo)(() => {
    ...
    return /* @__PURE__ */ __jsx(
      ...
      /* @__PURE__ */ __jsx(Row, { style: { justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 20, color: "#e2e8f0", fontWeight: "700" } }, "Braille Graph"), /* @__PURE__ */ __jsx(Row, { style: { gap: 12, alignItems: "center" } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 12, color: "#64748b" } }, "max ", maxVal.toFixed(2), "  min ", minVal.toFixed(2)), /* @__PURE__ */ __jsx(
        Pressable,
        {
        ...
        /* @__PURE__ */ __jsx(Text, { style: { fontSize: 13, color: "#f1f5f9" } }, animate ? "Pause" : "Play")
      ))),
      /* @__PURE__ */ __jsx(Row, { style: { gap: 8, flexWrap: "wrap" } }, MODES.map((m) => /* @__PURE__ */ __jsx(
        Pressable,
        {
          key: m.key,
        ...
        /* @__PURE__ */ __jsx(Text, { style: { fontSize: 13, color: "#f1f5f9" } }, m.label)
      ))),
      /* @__PURE__ */ __jsx(Row, { style: { gap: 8, alignItems: "center" } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 13, color: "#94a3b8" } }, "Zoom:"), /* @__PURE__ */ __jsx(
        Pressable,
        {
        ...
        /* @__PURE__ */ __jsx(Text, { style: { fontSize: 13, color: "#f1f5f9" } }, "\u2212")
      ), /* @__PURE__ */ __jsx(Text, { style: { fontSize: 13, color: "#94a3b8", minWidth: 24, textAlign: "center" } }, zoom), /* @__PURE__ */ __jsx(
        Pressable,
        {
      ...
      /* @__PURE__ */ __jsx(
        ...
        /* @__PURE__ */ __jsx(Row, { style: { flexGrow: 1, gap: 6 } }, /* @__PURE__ */ __jsx(
          Col,
          {
            style: {
              width: 32,
          ...
          /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569", lineHeight: 10 } }, "1.0"),
          /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569", lineHeight: 10 } }, "0.5"),
          /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569", lineHeight: 10 } }, "0.0"),
          /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569", lineHeight: 10 } }, "-0.5"),
          /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569", lineHeight: 10 } }, "-1.0")
        ), /* @__PURE__ */ __jsx(Col, { style: { flexGrow: 1, gap: 2 } }, /* @__PURE__ */ __jsx(Box, { style: { flexGrow: 1, justifyContent: "center", alignItems: "center" } }, /* @__PURE__ */ __jsx(Col, { style: { gap: 0 } }, lines.map((line, i) => /* @__PURE__ */ __jsx(
          Text,
          {
            key: i,
            style: {
          ...
          line
        )))), /* @__PURE__ */ __jsx(Row, { style: { justifyContent: "space-between", paddingLeft: 2 } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569" } }, "0"), /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569" } }, (zoom / 2).toFixed(1)), /* @__PURE__ */ __jsx(Text, { style: { fontSize: 10, color: "#475569" } }, zoom.toFixed(1)))))
      )
    );
  }
  ...
  (function installConsole() {
    const host5 = globalThis;
    const log = typeof host5.__hostLog === "function" ? host5.__hostLog : null;
    ...
    globalThis.console = {
      ...
      info: (...a) => emit3("info", a),
      warn: (...a) => emit3("warn", a),
      error: (...a) => emit3("error", a),
      debug: (...a) => emit3("debug", a),
      trace: (...a) => emit3("trace", a)
    };
  })();
  ...
  (function installAutoHotState() {
    if (React4.__sw_useStateAutoPatched) return;
    const realUseState = React4.useState;
    const realUseId = React4.useId;
    const realUseCallback = React4.useCallback;
    if (typeof realUseState !== "function" || typeof realUseId !== "function" || typeof realUseCallback !== "function") return;
    React4.useState = function useStateAutoHot(initial) {
      const id = realUseId.call(React4);
      const [value, setValue] = realUseState.call(React4, () => {
      ...
      const set2 = realUseCallback.call(React4, (updater) => {
        setValue((prev) => {
  ...
  function getInputTextForNode(id) {
    const host5 = globalThis;
    const getter = host5.__getInputTextForNode;
  ...
  function getPreparedRightClickPayload() {
    const host5 = globalThis;
    const getter = host5.__getPreparedRightClick;
    if (typeof getter !== "function") return {};
  ...
  function getPreparedScrollPayload() {
    const host5 = globalThis;
    const getter = host5.__getPreparedScroll;
    if (typeof getter !== "function") return {};
    const payload = getter();
    return payload && typeof payload === "object" ? payload : {};
  }
  function dispatchAliases(id, aliases, ...args) {
    ...
    if (!h2) return;
    const host5 = globalThis;
    const stampHandler = host5.__clickLatencyStampHandler;
  ...
  globalThis.__dispatchEvent = (id, type) => {
    const host5 = globalThis;
    const stampDispatch = host5.__clickLatencyStampDispatch;
  ...
  reconciler.updateContainer(React4.createElement(BrailleGraphCart, {}), container, null, null);
})();
/**
 * @license React

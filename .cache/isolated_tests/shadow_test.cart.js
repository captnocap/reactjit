(() => {
  ...
  // cart/app/isolated_tests/shadow_test.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  var import_react = __toESM(require_react());
  var SHADOW_COLOR = "rgba(0,0,0,0.55)";
  function ShadowCard({
    label,
    method,
    blur
    ...
    return /* @__PURE__ */ __jsx(
      ...
      /* @__PURE__ */ __jsx("span", { style: { fontSize: 16, color: "#0f172a", fontWeight: 600 } }, label),
      /* @__PURE__ */ __jsx("span", { style: { fontSize: 13, color: "#475569", marginTop: 4 } }, "blur ", blur)
    );
  }
  function App() {
    const [blur, setBlur] = (0, import_react.useState)(24);
    ...
    return /* @__PURE__ */ __jsx(
      ...
      /* @__PURE__ */ __jsx("div", { style: { flexDirection: "column", gap: 4 } }, /* @__PURE__ */ __jsx("span", { style: { fontSize: 22, color: "#f8fafc", fontWeight: 700 } }, "shadow method test"), /* @__PURE__ */ __jsx("span", { style: { fontSize: 13, color: "#94a3b8" } }, "left = sdf (wgsl shader) \xB7 right = rect (multi-rect fade) \xB7 same color/offset/blur")),
      /* @__PURE__ */ __jsx("div", { style: { flexDirection: "row", gap: 64, alignItems: "center" } }, /* @__PURE__ */ __jsx(ShadowCard, { label: "SDF (wgsl)", method: "sdf", blur }), /* @__PURE__ */ __jsx(ShadowCard, { label: "multi-rect", method: "rect", blur })),
      /* @__PURE__ */ __jsx("div", { style: { flexDirection: "row", gap: 12, alignItems: "center" } }, /* @__PURE__ */ __jsx(
        "button",
        {
          onClick: stepDown,
          style: {
        ...
        "blur +"
      ), /* @__PURE__ */ __jsx("span", { style: { fontSize: 14, color: "#cbd5e1" } }, "shadowBlur = ", blur, "px")),
      /* @__PURE__ */ __jsx("div", { style: { flexDirection: "column", gap: 12 } }, /* @__PURE__ */ __jsx("span", { style: { fontSize: 14, color: "#94a3b8" } }, "extreme blur sweep (sdf top row, rect bottom row):"), /* @__PURE__ */ __jsx("div", { style: { flexDirection: "row", gap: 24 } }, [8, 24, 48].map((b) => /* @__PURE__ */ __jsx(ShadowCard, { key: `sdf-${b}`, label: "sdf", method: "sdf", blur: b }))), /* @__PURE__ */ __jsx("div", { style: { flexDirection: "row", gap: 24 } }, [8, 24, 48].map((b) => /* @__PURE__ */ __jsx(ShadowCard, { key: `rect-${b}`, label: "rect", method: "rect", blur: b }))))
    );
  }

(() => {
  ...
  function LlmLab() {
    const [pickedIdx, setPickedIdx] = (0, import_react2.useState)(1);
    const picked = MODELS[pickedIdx];
    const [prompt, setPrompt] = (0, import_react2.useState)("Say something weirdly profound in under 15 words.");
    const [reply, setReply] = (0, import_react2.useState)("");
    const [askMs, setAskMs] = (0, import_react2.useState)(0);
    const [t0, setT0] = (0, import_react2.useState)(0);
    ...
    const status = chat.error ? `error: ${chat.error}` : `${chat.phase} \xB7 ${chat.lastStatus || "\u2014"} \xB7 pulse ${chat.pulse}`;
    const dot = chat.error ? C.err : chat.ready ? C.good : C.warn;
    return /* @__PURE__ */ __jsx(Box, { style: { width: "100%", height: "100%", backgroundColor: C.bg, flexDirection: "column" } }, /* @__PURE__ */ __jsx(
      Row,
      {
        style: {
      ...
      /* @__PURE__ */ __jsx(Col, null, /* @__PURE__ */ __jsx(Text, { style: { color: C.text, fontSize: 16, fontWeight: 600 } }, "LLM Lab"), /* @__PURE__ */ __jsx(Text, { style: { color: C.dim, fontSize: 12 } }, "dlopen'd LM Studio backend \xB7 text-gen on GPU without Vulkan contention")),
      /* @__PURE__ */ __jsx(Row, { style: { alignItems: "center", gap: 8 } }, /* @__PURE__ */ __jsx(Box, { style: { width: 8, height: 8, borderRadius: 4, backgroundColor: dot } }), /* @__PURE__ */ __jsx(Text, { style: { color: C.dim, fontSize: 12 } }, status))
    ), /* @__PURE__ */ __jsx(Col, { style: { flexGrow: 1, padding: 24, gap: 16 } }, /* @__PURE__ */ __jsx(Col, { style: { gap: 6 } }, /* @__PURE__ */ __jsx(Text, { style: { color: C.dim, fontSize: 12 } }, "Model"), /* @__PURE__ */ __jsx(Row, { style: { gap: 8, flexWrap: "wrap" } }, MODELS.map((m, i) => {
      ...
      return /* @__PURE__ */ __jsx(
        ...
        /* @__PURE__ */ __jsx(Text, { style: { color: active ? "#fff" : C.text, fontSize: 13, fontWeight: 600 } }, m.label)
      );
    })), /* @__PURE__ */ __jsx(Text, { style: { color: C.dim, fontSize: 11 } }, picked.note), /* @__PURE__ */ __jsx(Text, { style: { color: C.dim, fontSize: 11 } }, "Switching models on a live cart will re-init the session \u2014 wait for status to settle.")), /* @__PURE__ */ __jsx(Col, { style: { gap: 6 } }, /* @__PURE__ */ __jsx(Text, { style: { color: C.dim, fontSize: 12 } }, "Prompt"), /* @__PURE__ */ __jsx(
      TextInput,
      {
        value: prompt,
        onChange: setPrompt,
      ...
      /* @__PURE__ */ __jsx(Text, { style: { color: chat.ready ? "#fff" : C.dim, fontSize: 13, fontWeight: 600 } }, chat.phase === "generating" ? "Generating\u2026" : "Ask")
    ), askMs > 0 ? /* @__PURE__ */ __jsx(Text, { style: { color: C.dim, fontSize: 12, alignSelf: "center" } }, "last reply: ", askMs, " ms") : null)), /* @__PURE__ */ __jsx(
      Col,
      {
        style: {
          backgroundColor: C.surface,
      ...
      /* @__PURE__ */ __jsx(Text, { style: { color: C.text, fontSize: 13, fontWeight: 600 } }, "Output"),
      /* @__PURE__ */ __jsx(ScrollView, { style: { flexGrow: 1, minHeight: 0 } }, /* @__PURE__ */ __jsx(Text, { style: { color: C.text, fontSize: 13 } }, chat.phase === "generating" ? chat.streaming : reply || "(awaiting first ask)"))
    )));
  }

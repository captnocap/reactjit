(() => {
  ...
  // cart/app/isolated_tests/context_menu_demo.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  ...
  function App() {
    ...
    const submenuParentIdx = submenuFor ? items.findIndex((i) => i.label === submenuFor.label) : -1;
    return /* @__PURE__ */ __jsx(
      ...
      /* @__PURE__ */ __jsx("h1", { style: { fontSize: 26, color: "#f8fafc", margin: 0 } }, "useContextMenu \u2014 hover + nested + dismiss"),
      /* @__PURE__ */ __jsx("p", { style: { fontSize: 14, color: "#94a3b8", margin: 0 } }, 'right-click the tile. hover items to highlight; "Open With" opens a submenu. click outside to dismiss.'),
      /* @__PURE__ */ __jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ __jsx(
        ...
        items.map((it) => /* @__PURE__ */ __jsx(
          ...
          /* @__PURE__ */ __jsx("span", { style: { color: "#e5e7eb", fontSize: 14 } }, it.label),
          it.sub ? /* @__PURE__ */ __jsx("span", { style: { color: "#9ca3af", fontSize: 14 } }, "\u203A") : null
        ))
      ),
      isOpen && submenuFor && /* @__PURE__ */ __jsx(
        "div",
        {
          style: {
            position: "absolute",
        ...
        submenuFor.sub.map((label) => /* @__PURE__ */ __jsx(
          "div",
          {
            key: label,
            ...hoverSub(label),
          ...
          /* @__PURE__ */ __jsx("span", { style: { color: "#e5e7eb", fontSize: 14 } }, label)
        ))
      )
    );
  }

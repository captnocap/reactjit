(() => {
  ...
  // cart/app/isolated_tests/rotate_text.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  var import_react = __toESM(require_react());
  init_primitives();
  var STATIC_ANGLES = [-90, -45, 0, 45, 90, 135, 180, -135];
  function RotateText() {
    const [angle, setAngle] = (0, import_react.useState)(0);
    (0, import_react.useEffect)(() => {
      const id = setInterval(() => setAngle((a) => (a + 4) % 360), 32);
    ...
    return /* @__PURE__ */ __jsx(
      ...
      /* @__PURE__ */ __jsx(Text, { style: { fontSize: 24, fontWeight: 700, color: "#f8fafc" } }, "rotate text"),
      /* @__PURE__ */ __jsx(
        Box,
        {
          style: {
        ...
        STATIC_ANGLES.map((deg) => /* @__PURE__ */ __jsx(
          Box,
          {
            key: deg,
            style: {
          ...
          /* @__PURE__ */ __jsx(Box, { style: { transform: { rotate: deg } } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 18, color: "#7dd3fc", fontWeight: 600 } }, deg, "\xB0"))
        ))
      ),
      /* @__PURE__ */ __jsx(
        Box,
        ...
        /* @__PURE__ */ __jsx(
          ...
          /* @__PURE__ */ __jsx(Box, { style: { transform: { rotate: angle } } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 28, color: "#fbbf24", fontWeight: 700 } }, "spin \u2192"))
        ),
        /* @__PURE__ */ __jsx(
          Box,
          {
          ...
          /* @__PURE__ */ __jsx(Box, { style: { transform: { rotate: -angle } } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 28, color: "#a7f3d0", fontWeight: 700 } }, "\u2190 spin"))
        ),
        /* @__PURE__ */ __jsx(
          Box,
          {
          ...
          /* @__PURE__ */ __jsx(Box, { style: { transform: { rotate: angle } } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 14, color: "#f472b6" } }, "outer")),
          /* @__PURE__ */ __jsx(Box, { style: { transform: { rotate: -angle * 2 } } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 20, color: "#f8fafc", fontWeight: 700 } }, angle, "\xB0")),
          /* @__PURE__ */ __jsx(Box, { style: { transform: { rotate: angle } } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 14, color: "#f472b6" } }, "inner"))
        )
      ),
      /* @__PURE__ */ __jsx(Text, { style: { fontSize: 12, color: "#64748b" } }, "rotation via style.transform.rotate (degrees)")
    );
  }

(() => {
  ...
  // cart/app/isolated_tests/transparency_test.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  init_primitives();
  function App() {
    return /* @__PURE__ */ __jsx(
      ...
      /* @__PURE__ */ __jsx("div", { style: { width: 480, height: 320, position: "relative" } }, /* @__PURE__ */ __jsx(StaticSurface, { staticKey: "transparency-parent", style: { width: "100%", height: "100%" } }, /* @__PURE__ */ __jsx(
        "div",
        {
          style: {
            width: "100%",
        ...
        /* @__PURE__ */ __jsx("span", { style: { color: "#ffffff", fontSize: 32 } }, "BACKGROUND TEXT"),
        /* @__PURE__ */ __jsx("span", { style: { color: "#fde68a", fontSize: 18 } }, "line two \u2014 should be visible through the overlay"),
        /* @__PURE__ */ __jsx("div", { style: { height: 12, backgroundColor: "#000000", marginTop: 8 } }),
        /* @__PURE__ */ __jsx("div", { style: { height: 12, backgroundColor: "#ffffff", marginTop: 4 } }),
        /* @__PURE__ */ __jsx("div", { style: { height: 12, backgroundColor: "#000000", marginTop: 4 } }),
        /* @__PURE__ */ __jsx("div", { style: { height: 12, backgroundColor: "#ffffff", marginTop: 4 } }),
        /* @__PURE__ */ __jsx("span", { style: { color: "#ffffff", fontSize: 16, marginTop: 8 } }, "more parent content here")
      )), /* @__PURE__ */ __jsx(
        "div",
        {
          style: {
        ...
        /* @__PURE__ */ __jsx("span", { style: { color: "#ffffff", fontSize: 20 } }, "OVERLAY (a=0.4)")
      ))
    );
  }

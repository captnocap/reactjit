(() => {
  ...
  // cart/app/isolated_tests/font_lab/index.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  init_primitives();
  ...
  var FAMILIES = [
    { label: "Runtime default", family: void 0 },
  ...
  function typeStyle(family, size, extra = {}) {
    return {
      fontFamily: family,
      fontSize: size,
      color: COLORS.text,
  ...
  function Label({ children }) {
    return /* @__PURE__ */ __jsx(Text, { style: { fontSize: 11, color: COLORS.faint, fontWeight: 700, lineHeight: 15 } }, children);
  }
  function Header() {
    return /* @__PURE__ */ __jsx(Box, { style: { flexDirection: "column", gap: 8, marginBottom: 18 } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 34, lineHeight: 42, fontWeight: 700, color: COLORS.text } }, "Font Lab"), /* @__PURE__ */ __jsx(Text, { style: { fontSize: 13, lineHeight: 18, color: COLORS.dim, maxWidth: 880 } }, "Common font-family names rendered at UI sizes. Rows include ambiguous glyphs, punctuation, numerals, lowercase rhythm, and headline scale."), /* @__PURE__ */ __jsx(Box, { style: {
      marginTop: 8,
      paddingLeft: 12,
      paddingRight: 12,
      paddingTop: 9,
      ...
      borderWidth: 1,
      borderColor: "#6b5527"
    } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 12, lineHeight: 17, color: COLORS.warn } }, "If every row looks identical, the host is ignoring fontFamily. That is useful signal.")));
  }
  function SizeStrip({ family }) {
    return /* @__PURE__ */ __jsx(Box, { style: { flexDirection: "row", gap: 14, flexWrap: "wrap" } }, SIZES.map((size) => /* @__PURE__ */ __jsx(
      Box,
      {
        key: size,
        style: {
      ...
      /* @__PURE__ */ __jsx(Label, null, size, "px"),
      /* @__PURE__ */ __jsx(Text, { style: typeStyle(family, size) }, "Ag 012")
    )));
  }
  function FamilyCard({ label, family }) {
    return /* @__PURE__ */ __jsx(Box, { style: {
      ...
      borderColor: COLORS.rule,
      borderRadius: 6
    } }, /* @__PURE__ */ __jsx(Box, { style: { flexDirection: "row", justifyContent: "space-between", gap: 16, alignItems: "baseline" } }, /* @__PURE__ */ __jsx(Text, { style: { fontSize: 16, fontWeight: 700, color: COLORS.accent } }, label), /* @__PURE__ */ __jsx(Text, { style: { fontSize: 11, color: COLORS.faint, fontFamily: "monospace" } }, family ? `fontFamily: "${family}"` : "no fontFamily prop")), /* @__PURE__ */ __jsx(SizeStrip, { family }), /* @__PURE__ */ __jsx(Box, { style: { flexDirection: "column", gap: 8 } }, SPECIMENS.map((sample, index) => /* @__PURE__ */ __jsx(Box, { key: sample, style: { flexDirection: "row", gap: 12, alignItems: "baseline" } }, /* @__PURE__ */ __jsx(Box, { style: { width: 52, flexShrink: 0 } }, /* @__PURE__ */ __jsx(Label, null, index === 0 ? "body" : index === 1 ? "ui" : index === 2 ? "glyphs" : index === 3 ? "pangram" : "marks")), /* @__PURE__ */ __jsx(Text, { style: typeStyle(family, index === 1 ? 12 : 14, { color: index === 1 ? COLORS.dim : COLORS.text }) }, sample)))), /* @__PURE__ */ __jsx(Box, { style: { flexDirection: "row", gap: 18, alignItems: "baseline", flexWrap: "wrap" } }, /* @__PURE__ */ __jsx(Text, { style: typeStyle(family, 18, { fontWeight: 400 }) }, "Regular weight"), /* @__PURE__ */ __jsx(Text, { style: typeStyle(family, 18, { fontWeight: 700 }) }, "Bold weight"), /* @__PURE__ */ __jsx(Text, { style: typeStyle(family, 18, { letterSpacing: 1.5 }) }, "Tracked letters")));
  }
  function FontLab() {
    return /* @__PURE__ */ __jsx(Box, { style: { flexGrow: 1, backgroundColor: COLORS.bg, width: "100%", height: "100%" } }, /* @__PURE__ */ __jsx(ScrollView, { showScrollbar: true, style: { width: "100%", height: "100%" } }, /* @__PURE__ */ __jsx(Box, { style: {
      flexDirection: "column",
      gap: 14,
      paddingLeft: 28,
      paddingRight: 28,
      paddingTop: 26,
      paddingBottom: 34
    } }, /* @__PURE__ */ __jsx(Header, null), FAMILIES.map((entry) => /* @__PURE__ */ __jsx(FamilyCard, { key: entry.label, label: entry.label, family: entry.family })))));
  }

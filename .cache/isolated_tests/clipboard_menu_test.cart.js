(() => {
  ...
  // cart/app/isolated_tests/clipboard_menu_test.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  ...
  function getSelection() {
    return callHost("__selection_get", "");
  }

  // runtime/hooks/useContextMenu.tsx
  init_jsx_shim();
  init_ambient();
  init_ambient_primitives();
  ...
  function useContextMenu() {
    ...
    const triggerProps = {
      onRightClick: (e) => setState({ x: e.x, y: e.y })
    };
    const close = (0, import_react.useCallback)(() => setState(null), []);
    const ContextMenu = (0, import_react.useCallback)(
      ({
        children,
        style,
        onDismiss
        ...
        return /* @__PURE__ */ __jsx(Fragment, null, /* @__PURE__ */ __jsx(
          "div",
          {
            onClick: () => {
              setState(null);
  ...
  // cart/app/isolated_tests/clipboard_menu_test.tsx
  var STATIC_QUOTE = "wgsl crushes the other approach \u2014 josiah, ~2026-04";
  function MenuItem({
    label,
    onPick,
    disabled
  ...
  function App() {
    ...
    const [snapshot2, setSnapshot] = (0, import_react2.useState)({ selectionText: "", inputFocused: false });
    const [inputFocused, setInputFocused] = (0, import_react2.useState)(false);
    const baseMenu = useContextMenu();
    const append = (line) => setLog((prev) => [line, ...prev].slice(0, 8));
    const openMenuAt = (e) => {
      setSnapshot({
        selectionText: getSelection(),
        inputFocused
        // captured before right-click can blur the input
      });
      baseMenu.triggerProps.onRightClick(e);
    };
    const doCopy = () => {
      if (snapshot2.selectionText) {
        set(snapshot2.selectionText);
        append(`copied: "${snapshot2.selectionText}"`);
      }
      baseMenu.close();
    };
    const doPaste = () => {
    ...
    return /* @__PURE__ */ __jsx(
      ...
      /* @__PURE__ */ __jsx("div", { style: { flexDirection: "column", gap: 4 } }, /* @__PURE__ */ __jsx("span", { style: { fontSize: 22, color: "#f8fafc", fontWeight: 700 } }, "right-click \u2192 copy / paste (selection-gated)"), /* @__PURE__ */ __jsx("span", { style: { fontSize: 13, color: "#94a3b8" } }, "Copy appears only when something is highlighted. Paste appears only when an input is focused.")),
      /* @__PURE__ */ __jsx("div", { style: { flexDirection: "column", gap: 8 } }, /* @__PURE__ */ __jsx("span", { style: { fontSize: 12, color: "#64748b" } }, "read-only <Text> \u2014 double-click to highlight a word, then right-click"), /* @__PURE__ */ __jsx(
        "div",
        {
        ...
        /* @__PURE__ */ __jsx("span", { style: { color: "#f1f5f9", fontSize: 15 } }, STATIC_QUOTE)
      )),
      /* @__PURE__ */ __jsx("div", { style: { flexDirection: "column", gap: 8 } }, /* @__PURE__ */ __jsx("span", { style: { fontSize: 12, color: "#64748b" } }, "editable <input> \u2014 type, optionally select, then right-click"), /* @__PURE__ */ __jsx(
        "input",
        {
          value,
      ...
      ), /* @__PURE__ */ __jsx("span", { style: { fontSize: 12, color: "#475569" } }, 'value: "', value, '" (', value.length, " chars) \xB7 focused: ", inputFocused ? "yes" : "no")),
      /* @__PURE__ */ __jsx(
        "div",
        {
          style: {
        ...
        /* @__PURE__ */ __jsx("span", { style: { color: "#a7f3d0", fontSize: 13 } }, "log:"),
        log.length === 0 ? /* @__PURE__ */ __jsx("span", { style: { color: "#475569", fontSize: 13 } }, "(none yet)") : log.map((line, i) => /* @__PURE__ */ __jsx("span", { key: i, style: { color: "#cbd5e1", fontSize: 13 } }, line))
      ),
      /* @__PURE__ */ __jsx(
        ...
        snapshot2.selectionText.length > 0 && /* @__PURE__ */ __jsx(MenuItem, { label: "Copy", onPick: doCopy }),
        snapshot2.inputFocused && /* @__PURE__ */ __jsx(MenuItem, { label: "Paste", onPick: doPaste }),
        snapshot2.selectionText.length === 0 && !snapshot2.inputFocused && /* @__PURE__ */ __jsx(MenuItem, { label: "(nothing to do)", onPick: () => baseMenu.close(), disabled: true })
      )
    );
  }

...
|-----|-------------|------------|-----------|
| taskboard.app.tsz | 3D kanban board | box, sphere, torus, cylinder, cone, plane | 2 (board + showcase) |
| dashboard.app.tsz | 3D data dashboard | box, sphere, torus, cylinder, plane | 2 (chart + status orb) |

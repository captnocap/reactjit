//! Generated by tsz compiler — d33_extreme_nesting [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "action: {s}", .{ state.getSlotString(0) }) catch "";
    nodes._arr_34[2].text = st._dyn_text_0;
}
...
export fn app_get_title() [*:0]const u8 { return "d33_extreme_nesting"; }

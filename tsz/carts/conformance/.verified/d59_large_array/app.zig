//! Generated by tsz compiler — d59_large_array [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "total: {d} · sel: {d}", .{ state.getSlot(1), state.getSlot(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d59_large_array"; }

//! Generated by tsz compiler — d69_chat_ui [app.zig]
...
fn _updateConditionals() void {
    nodes._arr_9[1].style.display = if ((state.getSlot(0) ==  0)) .flex else .none;
}
...
export fn app_get_title() [*:0]const u8 { return "d69_chat_ui"; }

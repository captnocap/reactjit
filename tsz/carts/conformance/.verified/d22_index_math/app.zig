//! Generated by tsz compiler — d22_index_math [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "tapped row: {d}", .{ state.getSlot(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d22_index_math"; }

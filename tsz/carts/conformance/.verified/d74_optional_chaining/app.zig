//! Generated by tsz compiler — d74_optional_chaining [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "checks: {d}", .{ state.getSlot(1) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d74_optional_chaining"; }

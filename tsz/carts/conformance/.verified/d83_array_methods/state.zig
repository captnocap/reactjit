...
// [origin:d83_array_methods:state]
// ── State manifest ──────────────────────────────────────────────
...
// [origin:d83_array_methods:oa:_oa0_unpack]
...
pub var _oa1_name = [_][]const u8{ "Zulu", "Alpha", "Mike", "Bravo", "Yankee", "Delta" };
pub var _oa1_name_lens = [_]usize{ 4, 5, 4, 5, 6, 5 };
pub var _oa1_value = [_]i64{ 5, 30, 15, 25, 10, 20 };

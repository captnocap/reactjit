//! Generated by tsz compiler — d05_dynamic_style_in_map [app.zig]
...
export fn app_get_title() [*:0]const u8 { return "d05_dynamic_style_in_map"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d05_dynamic_style_in_map",
        .root = &nodes._root,

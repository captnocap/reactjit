//! Generated by tsz compiler — d28a_string_ops_script [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} results · {s}", .{ state.getSlot(1), state.getSlotString(2) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d28a_string_ops_script"; }

//! Generated by tsz compiler — d81_rest_spread_params [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} entries", .{ state.getSlot(1) }) catch "";
    nodes._arr_7[1].text = st._dyn_text_0;
    st._dyn_text_1 = std.fmt.bufPrint(&st._dyn_buf_1, "{s}", .{ state.getSlotString(0) }) catch "";
    nodes._arr_7[4].text = st._dyn_text_1;
}
...
export fn app_get_title() [*:0]const u8 { return "d81_rest_spread_params"; }

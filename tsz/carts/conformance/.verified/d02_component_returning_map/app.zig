//! Generated by tsz compiler — d02_component_returning_map [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "picked: {d}", .{ state.getSlot(0) }) catch "";
...
// ── Smith debug log ──
// DBG: [INLINE PROBE] Inlining component: TagList bodyPos: 51 token: tags kind: 0

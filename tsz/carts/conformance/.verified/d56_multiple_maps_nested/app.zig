//! Generated by tsz compiler — d56_multiple_maps_nested [app.zig]
...
export fn app_get_title() [*:0]const u8 { return "d56_multiple_maps_nested"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d56_multiple_maps_nested",
        .root = &nodes._root,

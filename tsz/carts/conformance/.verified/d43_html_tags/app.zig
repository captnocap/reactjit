//! Generated by tsz compiler — d43_html_tags [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} clicks", .{ state.getSlot(1) }) catch "";
    nodes._arr_5[1].text = st._dyn_text_0;
    st._dyn_text_1 = std.fmt.bufPrint(&st._dyn_buf_1, "last clicked: {s}", .{ state.getSlotString(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d43_html_tags"; }

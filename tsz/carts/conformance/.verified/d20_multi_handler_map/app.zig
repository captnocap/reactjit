//! Generated by tsz compiler — d20_multi_handler_map [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "action: {s} · clip: {s} · downloads: {d}", .{ state.getSlotString(0), state.getSlotString(1), state.getSlot(2) }) catch "";
    nodes._arr_7[2].text = st._dyn_text_0;
}
...
export fn app_get_title() [*:0]const u8 { return "d20_multi_handler_map"; }

//! Generated by tsz compiler — l06b_http_client [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} pending", .{ state.getSlot(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "l06b_http_client"; }

//! Generated by tsz compiler — d44_classifier_styles [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "Actions: {d}", .{ state.getSlot(1) }) catch "";
    nodes._arr_6[0].text = st._dyn_text_0;
...
export fn app_get_title() [*:0]const u8 { return "d44_classifier_styles"; }

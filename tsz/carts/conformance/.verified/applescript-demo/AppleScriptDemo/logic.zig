//! Generated by tsz compiler — AppleScriptDemo [logic.zig]
//! Source: AppleScriptDemo.tsz


// [origin:AppleScriptDemo:logic]
// ── Embedded JS logic ────────────────────────────────────────
pub const JS_LOGIC =
    \\// Ambient namespaces
    \\var time = {
...
pub const LUA_LOGIC =
    ...
    \\result = 'Press a button to run a script'
    \\
    \\function setResult(v) result = v; __setStateString(0, v) end
    \\
    \\
;

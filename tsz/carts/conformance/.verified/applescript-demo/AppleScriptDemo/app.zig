//! Generated by tsz compiler — AppleScriptDemo [app.zig]
...
fn _updateDynamicTexts() void {
    ...
    nodes._arr_13[0].text = st._dyn_text_0;
}
...
fn _appTick(now: u32) void {
    _ = now;
    @import("framework/applescript.zig").pollResult();
...
export fn app_get_title() [*:0]const u8 { return "AppleScriptDemo"; }

//! Generated by tsz compiler — d42_export_import [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "mode: {d} · {s}", .{ state.getSlot(0), state.getSlotString(1) }) catch "";
    nodes._arr_7[3].text = st._dyn_text_0;
}
...
export fn app_get_title() [*:0]const u8 { return "d42_export_import"; }

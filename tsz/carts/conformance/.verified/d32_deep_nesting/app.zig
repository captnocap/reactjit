//! Generated by tsz compiler — d32_deep_nesting [app.zig]
...
fn _updateDynamicTexts() void {
    ...
    nodes._arr_21[2].text = st._dyn_text_0;
}
...
export fn app_get_title() [*:0]const u8 { return "d32_deep_nesting"; }

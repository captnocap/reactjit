...
// [origin:d71_increment_decrement:state]
// ── State manifest ──────────────────────────────────────────────
// slot 0: total (int)
...
// [origin:d71_increment_decrement:oa:_oa0_unpack]
...
pub var _oa1_label = [_][]const u8{ "A", "B", "C" };
pub var _oa1_label_lens = [_]usize{ 1, 1, 1 };
pub var _oa1_value = [_]i64{ 0, 10, 20 };

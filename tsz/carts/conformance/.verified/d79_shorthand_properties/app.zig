//! Generated by tsz compiler — d79_shorthand_properties [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} items", .{ state.getSlot(1) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d79_shorthand_properties"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d79_shorthand_properties",
        .root = &nodes._root,

//! Generated by tsz compiler — d76_new_expression [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} tests run", .{ state.getSlot(1) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d76_new_expression"; }

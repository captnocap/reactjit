//! Generated by tsz compiler — d21_nested_object_access [app.zig]
...
export fn app_get_title() [*:0]const u8 { return "d21_nested_object_access"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d21_nested_object_access",
        .root = &nodes._root,

//! Generated by tsz compiler — d17_map_conditional_card [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} found · selected: {d} · {s}", .{ state.getSlot(2), state.getSlot(0), state.getSlotString(1) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d17_map_conditional_card"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d17_map_conditional_card",
        .root = &nodes._root,

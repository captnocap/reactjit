//! Generated by tsz compiler — d04_map_handler_captures [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "Bonus: {d}", .{ state.getSlot(0) }) catch "";
    nodes._arr_0[0].text = st._dyn_text_0;
    st._dyn_text_1 = std.fmt.bufPrint(&st._dyn_buf_1, "result: {d}", .{ state.getSlot(1) }) catch "";

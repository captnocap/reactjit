//! Generated by tsz compiler — map_matrix [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "Last action: {s}", .{ state.getSlotString(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "map_matrix"; }

export fn app_state_count() usize { return 1; }
const _slot_types = [_]u8{ 3 };

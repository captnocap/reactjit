//! Generated by tsz compiler — d34_switch_forof_while [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "total: {d}", .{ state.getSlot(2) }) catch "";
    nodes._arr_8[3].text = st._dyn_text_0;
...
export fn app_get_title() [*:0]const u8 { return "d34_switch_forof_while"; }

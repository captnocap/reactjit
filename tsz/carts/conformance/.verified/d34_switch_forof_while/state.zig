...
// [origin:d34_switch_forof_while:state]
// ── State manifest ──────────────────────────────────────────────
// slot 0: mode (int)
...
// [origin:d34_switch_forof_while:oa:_oa0_unpack]
...
pub var _oa1_label = [_][]const u8{ "Alpha", "Beta", "Gamma", "Delta", "Epsilon" };
pub var _oa1_label_lens = [_]usize{ 5, 4, 5, 5, 7 };
pub var _oa1_category = [_]i64{ 0, 1, 2, 0, 1 };
pub var _oa1_value = [_]i64{ 10, 20, 30, 40, 50 };

//! Generated by tsz compiler — d141_log_selector_nested_map [app.zig]
...
export fn app_get_title() [*:0]const u8 { return "d141_log_selector_nested_map"; }

export fn app_state_count() usize { return 2; }
const _slot_types = [_]u8{ 0, 2 };
...
pub fn main() !void {
    try engine.run(.{
        .title = "d141_log_selector_nested_map",
        .root = &nodes._root,

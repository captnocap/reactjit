//! Generated by tsz compiler — d19_polymorphic_map [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "last: {s}", .{ state.getSlotString(0) }) catch "";
    nodes._arr_9[2].text = st._dyn_text_0;
}
...
export fn app_get_title() [*:0]const u8 { return "d19_polymorphic_map"; }

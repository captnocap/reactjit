//! Generated by tsz compiler — d38_arrow_default_params [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "count: {d} · {s}", .{ state.getSlot(1), state.getSlotString(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d38_arrow_default_params"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d38_arrow_default_params",
        .root = &nodes._root,

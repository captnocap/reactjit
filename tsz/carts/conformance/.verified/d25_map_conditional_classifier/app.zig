//! Generated by tsz compiler — d25_map_conditional_classifier [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "selected: {s} · action: {s}", .{ state.getSlotString(0), state.getSlotString(1) }) catch "";
    nodes._arr_15[2].text = st._dyn_text_0;
}
...
export fn app_get_title() [*:0]const u8 { return "d25_map_conditional_classifier"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d25_map_conditional_classifier",
        .root = &nodes._root,

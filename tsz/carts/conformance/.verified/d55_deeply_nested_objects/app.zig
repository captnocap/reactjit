//! Generated by tsz compiler — d55_deeply_nested_objects [app.zig]
...
fn _updateDynamicTexts() void {
    ...
    nodes._arr_6[3].text = st._dyn_text_1;
}
...
export fn app_get_title() [*:0]const u8 { return "d55_deeply_nested_objects"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d55_deeply_nested_objects",
        .root = &nodes._root,

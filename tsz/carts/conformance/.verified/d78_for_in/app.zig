//! Generated by tsz compiler — d78_for_in [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} keys", .{ state.getSlot(1) }) catch "";
    nodes._arr_7[1].text = st._dyn_text_0;
    st._dyn_text_1 = std.fmt.bufPrint(&st._dyn_buf_1, "{s}", .{ state.getSlotString(0) }) catch "";
    nodes._arr_7[5].text = st._dyn_text_1;
}

fn _updateConditionals() void {
    nodes._arr_7[4].style.display = if ((state.getSlot(1) ==  0)) .flex else .none;
}
...
export fn app_get_title() [*:0]const u8 { return "d78_for_in"; }

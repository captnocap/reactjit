...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "offset: {d}", .{ state.getSlot(0) }) catch "";
    nodes._arr_0[0].text = st._dyn_text_0;
    st._dyn_text_1 = std.fmt.bufPrint(&st._dyn_buf_1, "log: {d}", .{ state.getSlot(1) }) catch "";
    nodes._arr_2[2].text = st._dyn_text_1;
}

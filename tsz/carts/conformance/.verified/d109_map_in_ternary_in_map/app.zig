//! Generated by tsz compiler — d109_map_in_ternary_in_map [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "expanded: {d} | last: {d}", .{ state.getSlot(0), state.getSlot(1) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d109_map_in_ternary_in_map"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d109_map_in_ternary_in_map",
        .root = &nodes._root,

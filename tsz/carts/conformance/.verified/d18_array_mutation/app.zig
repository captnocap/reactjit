//! Generated by tsz compiler — d18_array_mutation [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "last removed: {s}", .{ state.getSlotString(1) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d18_array_mutation"; }

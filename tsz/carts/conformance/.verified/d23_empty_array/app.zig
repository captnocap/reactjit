//! Generated by tsz compiler — d23_empty_array [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "mode: {d} · count: {d}", .{ state.getSlot(0), state.getSlot(1) }) catch "";
    nodes._arr_7[4].text = st._dyn_text_0;
}

fn _updateConditionals() void {
    nodes._arr_7[2].style.display = if ((state.getSlot(1) ==  0)) .flex else .none;
}
...
export fn app_get_title() [*:0]const u8 { return "d23_empty_array"; }

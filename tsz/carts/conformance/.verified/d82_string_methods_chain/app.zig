//! Generated by tsz compiler — d82_string_methods_chain [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d} ops · {s}", .{ state.getSlot(1), state.getSlotString(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d82_string_methods_chain"; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "d82_string_methods_chain",
        .root = &nodes._root,

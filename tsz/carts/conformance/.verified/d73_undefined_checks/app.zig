//! Generated by tsz compiler — d73_undefined_checks [app.zig]
...
fn _updateDynamicTexts() void {
    st._dyn_text_0 = std.fmt.bufPrint(&st._dyn_buf_0, "{d}/6 configured", .{ state.getSlot(1) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "d73_undefined_checks"; }

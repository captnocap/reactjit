...
Real-world app clones that validate the tsz compiler and framework against patterns used in production React/web applications. Each cart is a self-contained `.tsz` + `.script.tsz` pair with hardcoded data.

## Build

```bash
bin/tsz build tsz/carts/parity/<dir>/<name>.tsz
bin/tsz dev tsz/carts/parity/<dir>/<name>.tsz   # hot-reload
```
...
### Hacker News
**Entry:** `hackernews/hackernews.tsz`
...
### Reddit Clone
**Entry:** `reddit-clone/RedditClone.tsz`
...
### GitHub Issues
**Entry:** `github-issues/github-issues.tsz`
...
### Spotify Clone
**Entry:** `spotify-clone/spotify.tsz`
...
### Twitter/X Clone
**Entry:** `twitter-clone/twitter-clone.tsz`
...
### Slack Clone
**Entry:** `slack-clone/slack-clone.tsz`
...
### VS Code Clone
**Entry:** `vscode-clone/vscode-clone.tsz`
...
### Notion Clone
**Entry:** `notion-clone/notion-clone.tsz`
...
### Analytics Dashboard
**Entry:** `dashboard-analytics/dashboard-analytics.tsz`
...
### Figma Clone
**Entry:** `figma-clone/figma-clone.tsz`

...
// ── Generated node tree ─────────────────────────────────────────
// tsz:template.app.tsz:8 — <Pressable>
var _arr_0 = [_]Node{ .{ .text = "+1", .text_color = Color.rgb(255, 255, 255) } };
// tsz:template.app.tsz:6 — <Box>
var _arr_1 = [_]Node{ .{ .text = "", .font_size = 24, .text_color = Color.rgb(255, 255, 255) }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(233, 69, 96), .border_radius = 8 }, .handlers = .{ .on_press = _handler_press_0 }, .children = &_arr_0 } };
...
var _dyn_buf_0: [163]u8 = undefined;
...
fn _updateDynamicTexts() void {
    _dyn_text_0 = std.fmt.bufPrint(&_dyn_buf_0, "Hello {s}! Count: {d}", .{ state.getSlotString(1), state.getSlot(0) }) catch "";
...
export fn app_get_title() [*:0]const u8 { return "template.app"; }

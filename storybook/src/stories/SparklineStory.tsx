...
export function SparklineStory() {
  ...
  return (
    <Box style={{ width: '100%', gap: 20, padding: 16 }}>
      ...
      {/* Basic Sparkline */}
      <Box style={{ gap: 6 }}>
        <Text style={{ color: c.textSecondary, fontSize: 11, fontWeight: 'bold' }}>Basic Sparkline</Text>
      ...
      <Box style={{ gap: 6 }}>
        ...
        <Box style={{ gap: 8 }}>
          <Box style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}>
            <Text style={{ color: c.textSecondary, fontSize: 10, width: 60 }}>60 x 16</Text>
            <Sparkline data={SAMPLE_DATA} width={60} height={16} />
          </Box>
          <Box style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}>
            <Text style={{ color: c.textSecondary, fontSize: 10, width: 60 }}>80 x 24</Text>
            <Sparkline data={SAMPLE_DATA} width={80} height={24} />
          </Box>
          <Box style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}>
            <Text style={{ color: c.textSecondary, fontSize: 10, width: 60 }}>120 x 32</Text>
            <Sparkline data={SAMPLE_DATA} width={120} height={32} />
          </Box>
          <Box style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}>
            <Text style={{ color: c.textSecondary, fontSize: 10, width: 60 }}>200 x 48</Text>
      ...
      <Box style={{ gap: 6 }}>
        <Text style={{ color: c.textSecondary, fontSize: 11, fontWeight: 'bold' }}>Inline KPI Cards</Text>
        <Box style={{ gap: 8 }}>
          {[
            ...
            <Box key={kpi.label} style={{
              ...
              <Box style={{ width: 100, height: 30, gap: 2 }}>
                <Text style={{ color: c.textSecondary, fontSize: 10 }}>{kpi.label}</Text>
                <Text style={{ color: c.text, fontSize: 16, fontWeight: 'bold' }}>{kpi.value}</Text>
              </Box>
      ...
      {/* Colors */}
      <Box style={{ gap: 6 }}>
        <Text style={{ color: c.textSecondary, fontSize: 11, fontWeight: 'bold' }}>Colors</Text>
        <Box style={{ gap: 6 }}>

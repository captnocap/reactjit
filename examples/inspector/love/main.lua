--[[
  Cartridge Inspector — standalone app

  The trust layer for CartridgeOS.  Drop a manifest.json (or future: .cart
  binary) to see the full nutrition label.  This app itself declares zero
  network, zero clipboard — fully self-auditing.
]]

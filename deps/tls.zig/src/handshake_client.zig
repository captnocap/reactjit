...
const mem = std.mem;
const Io = std.Io;
const Timestamp = @import("compat.zig").Timestamp;
...
pub const Options = struct {
    ...
    pub const SessionResumption = struct {
        ...
        pub const Ticket = struct {
            ...
            pub fn init(payload: []const u8, secret: []const u8, now: Timestamp) !Ticket {
            ...
            /// using this ticket.
            pub fn obfuscatedAge(t: Ticket, now: Timestamp) u32 {
        ...
        pub fn init(allocator: mem.Allocator, now: Timestamp) Self {
            return .{
                .allocator = allocator,
                .now = now,
            };

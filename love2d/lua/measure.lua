...
function Measure.getFont(size, fontFamily, fontWeight)
  ...
  -- Shortcut: 'monospace' resolves to bundled DejaVu Sans Mono
  if fontFamily == "monospace" then
    if isBold then
      fontFamily = "fonts/base/DejaVuSansMono-Bold.ttf"
    else
      fontFamily = "fonts/base/DejaVuSansMono.ttf"
    end
  end

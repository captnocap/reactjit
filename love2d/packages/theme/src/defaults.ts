import type { ThemeTypography, ThemeSpacing, ThemeRadii, ThemeEffects, ThemeShaders, ThemeSprites } from './types';
...
export const defaultEffects: ThemeEffects = { background: null, mask: null, ambient: null };

export const defaultShaders: ThemeShaders = { grade: null };

export const defaultSprites: ThemeSprites = { atlases: {} };
